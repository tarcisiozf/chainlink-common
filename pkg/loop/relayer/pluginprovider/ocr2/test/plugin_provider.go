...
import (
	...
	chaincomponentstest2 "github.com/smartcontractkit/chainlink-common/pkg/loop/relayer/pluginprovider/contractreader/test"
...
func newStaticPluginProvider(lggr logger.Logger) staticPluginProvider {
	...
	return staticPluginProvider{
		...
		contractReader:         chaincomponentstest2.ContractReader,
		codec:                  chaincomponentstest2.Codec,
	}
}
